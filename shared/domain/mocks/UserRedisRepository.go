...
func (_m *UserRedisRepository) GetByID(c context.Context, id string) (domain.User, error) {
	ret := _m.Called(c, id)
...
type mockConstructorTestingTNewUserRedisRepository interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewUserRedisRepository(t mockConstructorTestingTNewUserRedisRepository) *UserRedisRepository {
